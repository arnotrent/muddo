...
def index(request):
    ...
    why_cards = [
        ('shield-alt','#c43010','#fce8e2','100% Authentic','All products MAAIF-registered, sourced directly from certified manufacturers. Zero counterfeits.'),
        ('users','#1a6abf','#e0eeff','Farmer First','Pricing and advice built around Uganda\'s farmers — retail and wholesale, no minimum order.'),
        ...
        ('headset','#c43010','#fce8e2','Expert Support','Our trained team gives dosage guidance, application timing and crop-specific advice — free.'),
        ('handshake','#1a6abf','#e0eeff','Long-term Partners','We build lasting relationships with farmers and distributors, not just one-off transactions.'),
    ]
    categories = [
        ('bug','#c43010','#fce8e2','Pesticides','pesticides','/static/images/product_acelemectin.png'),
        ('seedling','#2d6e35','#e8f5e9','Herbicides','herbicides','/static/images/product_maizeplus.png'),
        ('microscope','#5e35b1','#ede0ff','Fungicides','fungicides','/static/images/product_toplaxym.png'),
        ('boxes','#a06810','#fef5e0','Fertilizers & Equipment','other_products','/static/images/products_all.png'),
    ]
...
def about(request):
    ...
    product_samples=[
        ('Muddosate 480SL','Herbicide','#2d6e35','#e8f5e9'),('MD Maize Plus 40OD','Herbicide','#2d6e35','#e8f5e9'),
        ('MAX 2.4-D 720SL','Herbicide','#2d6e35','#e8f5e9'),('MD Ametryn 500SC','Herbicide','#2d6e35','#e8f5e9'),
        ('Weed IT 75.7 XL','Herbicide','#2d6e35','#e8f5e9'),('MD Acelemectin 48EC','Pesticide','#c43010','#fce8e2'),
        ('MD FOS 48EC','Pesticide','#c43010','#fce8e2'),('Top Fenos 50EC','Pesticide','#c43010','#fce8e2'),
        ('MD Thion 350EC','Pesticide','#c43010','#fce8e2'),('MD Thoate 40EC','Pesticide','#c43010','#fce8e2'),
        ('Top-Laxly M 72WP','Fungicide','#5e35b1','#ede0ff'),('MD Top Laxlyn 72WP','Fungicide','#5e35b1','#ede0ff'),
        ('Toplaxly 72WP','Fungicide','#5e35b1','#ede0ff'),('Copper Oxychloride 850WP','Fungicide','#5e35b1','#ede0ff'),
        ('Urea 46%N','Fertilizer','#a06810','#fef5e0'),('NPK 17:17:17','Fertilizer','#a06810','#fef5e0'),
        ('Foliar Boost 20-20-20','Fertilizer','#a06810','#fef5e0'),('Knapsack Sprayer 16L','Equipment','#1a6abf','#e0eeff'),
    ]
...
def contact(request):
    ...
    contact_items = [
        ('map-marker-alt','Our Location','Container Village Nakivubo, Equity Bank Basement V013, P.O Box 25240, Kampala',''),
        ('phone','Phone / WhatsApp','<a href="tel:+256772507582" style="color:var(--orange)">+256 772 507582</a> / <a href="tel:+256702507582" style="color:var(--orange)">0702-507582</a><br><a href="tel:+256772971620" style="color:var(--orange)">0772 971620</a> / <a href="tel:+256701971620" style="color:var(--orange)">0701-971620</a>',''),
        ('envelope','Email','<a href="mailto:kulanju_w@yahoo.com" style="color:var(--orange)">kulanju_w@yahoo.com</a>',''),
        ('clock','Business Hours','Monday – Saturday: 8:00am – 6:00pm',''),
        ('facebook','Facebook','<a href="https://facebook.com/p/MUDDO-AGRO-Chemicals-LTD-100063836929481/" target="_blank" style="color:var(--orange)">MUDDO AGRO Chemicals LTD</a>',''),
    ]
