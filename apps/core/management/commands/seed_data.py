...
PRODUCTS=[
 {'name':'MUDDOSATE 480SL','category':'herbicide','img':'/static/images/product_muddosate.png','stock':120,'reorder':20,
  ...
  'description':'MUDDOSATE is MACL\'s flagship non-selective systemic herbicide for total control of annual and perennial weeds including Couch grass and Kikuyu grass. Absorbed through leaves and translocated throughout the plant to the roots. Available wholesale and retail across Uganda.'},
 {'name':'MD MAIZE PLUS 40OD','category':'herbicide','img':'/static/images/product_maizeplus.png','stock':95,'reorder':15,
  ...
  'description':'MD MAIZE PLUS is a selective post-emergence herbicide for control of grass and broad-leaved weeds in maize. Highly effective — once used you will not regret it. Available in all package sizes for wholesale and small quantities.'},
 {'name':'MAX 2.4-D 720SL','category':'herbicide','img':'/static/images/product_max24d_selective.png','stock':140,'reorder':25,
 ...
 {'name':'MD AMETRYN 500SC','category':'herbicide','img':'/static/images/products_all.png','stock':60,'reorder':10,
  ...
  'dosage':'4–6 L/ha in 400–600 L water. Apply to moist soil.',
  'packing':'500ml, 1L, 5L',
  'description':'MD AMETRYN is an MACL-distributed selective herbicide as listed on the official company letterhead. Trusted by sugarcane and pineapple growers across Uganda.'},
 {'name':'WEED IT 75.7 XL','category':'herbicide','img':'/static/images/products_all.png','stock':75,'reorder':15,
  'active_ingredient':'Glyphosate 75.7% w/w','formulation':'Water Soluble Granule (SG)',
  'crops':'Non-selective — pre-plant or directed spray in all crops',
  'dosage':'1.5–2.5 kg/ha in 200–300 L water.',
  'packing':'200g, 500g, 1kg',
  'description':'WEED IT 75.7 XL is an MACL-distributed product listed on the official company letterhead. Concentrated water-soluble granule for cost-effective, complete vegetation control.'},
 {'name':'MD ACELEMECTIN 48EC','category':'pesticide','img':'/static/images/product_acelemectin.png','stock':88,'reorder':15,
  ...
  'description':'MD ACELEMECTIN 48EC is a broad-spectrum insecticide for control of all sucking and biting insect pests. Outstanding performance on mites, aphids, whitefly and bollworm on watermelon, passion fruit and tomatoes. Available wholesale and retail at MACL.'},
 {'name':'MD FOS 48EC','category':'pesticide','img':'/static/images/product_mdfos.png','stock':105,'reorder':20,
  ...
  'packing':'100ml, 250ml, 500ml, 1L, 5L',
  'description':'M-D FOS 48EC is a broad-spectrum organophosphate insecticide with contact and stomach action. Effective against stem borers, army worms, aphids and soil-dwelling larvae. Available wholesale and retail.'},
 {'name':'TOP FENOS 50EC','category':'pesticide','img':'/static/images/products_all.png','stock':55,'reorder':10,
  ...
  'dosage':'500 ml–1 L/ha in 200–300 L water. Repeat after 10–14 days.',
 ...
 {'name':'MD THION 350EC','category':'pesticide','img':'/static/images/products_all.png','stock':70,'reorder':12,
  ...
  'packing':'100ml, 250ml, 500ml, 1L',
  'description':'MD THION is an MACL-listed organophosphate insecticide providing reliable systemic and contact control of thrips, mites, aphids and caterpillars on key Ugandan crops.'},
 {'name':'MD THOATE 40EC','category':'pesticide','img':'/static/images/products_all.png','stock':62,'reorder':10,
  ...
  'description':'MD THOATE 40EC is distributed by MACL as listed on the official company letterhead. Systemic insecticide and acaricide with contact and stomach action for a wide range of pests.'},
 {'name':'TOP-LAXLY M 72WP','category':'fungicide','img':'/static/images/product_toplaxym.png','stock':115,'reorder':20,
  ...
  'description':'TOP-LAXLY M is a systemic fungicide for control of downy mildew, black spots and blight. Available in 3 package sizes. Very effective on VEGETABLES once applied. A top MACL product with excellent farmer results across Uganda.'},
 {'name':'MD TOP LAXLYN 72WP','category':'fungicide','img':'/static/images/product_toplaxlyn.png','stock':90,'reorder':15,
  ...
  'description':'MD TOP LAXLYN 72WP is a systemic and contact fungicide for control of downy mildew and Alternaria blight. MACL-distributed with proven performance across Uganda\'s vegetable farms.'},
 {'name':'TOPLAXLY 72WP','category':'fungicide','img':'/static/images/products_all.png','stock':80,'reorder':15,
  ...
  'packing':'100g, 250g, 500g, 1kg',
  'description':'TOPLAXLY (as listed on the MACL company letterhead) is a protective and curative fungicide against late blight and downy mildew. Available across the MACL nationwide distributor network.'},
 {'name':'COPPER OXYCHLORIDE 850WP','category':'fungicide','img':'/static/images/products_all.png','stock':78,'reorder':12,
  ...
  'description':'A trusted multi-site protective fungicide and bactericide for fungal and bacterial diseases. Long-established MACL product used by coffee and vegetable farmers across all regions of Uganda.'},
 {'name':'UREA 46%N','category':'other','img':'/static/images/products_all.png','stock':200,'reorder':40,
  ...
  'description':'High-analysis nitrogen fertilizer for rapid vegetative growth. The most concentrated solid nitrogen source, widely used by Uganda\'s farmers for maize, vegetables and cash crops. Available at MACL wholesale and retail.'},
 {'name':'NPK 17:17:17','category':'other','img':'/static/images/products_all.png','stock':180,'reorder':30,
 ...
 {'name':'FOLIAR BOOST 20-20-20+TE','category':'other','img':'/static/images/products_all.png','stock':95,'reorder':15,
 ...
 {'name':'KNAPSACK SPRAYER 16L','category':'other','img':'/static/images/product_store.png','stock':35,'reorder':5,
...
class Command(BaseCommand):
    ...
    def handle(self,*a,**o):
        ...
        if not Product.objects.exists() or force:
            ...
            added=0
            for r in PRODUCTS:
                p,created=Product.objects.get_or_create(name=r['name'],defaults={k:r[k] for k in ('category','description','active_ingredient','formulation','crops','dosage','packing') if k in r}|{'image_url':r.get('img','/static/images/products_all.png')})
