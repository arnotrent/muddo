...
META={'pesticide':{'template':'products/pesticides.html','page_title':'Pesticides','page_tag':'Insect & Pest Control',
       'page_desc':'Professional-grade MAAIF-registered insecticides for all major crop pests across Uganda.','hero_icon':'bug','hero_color':'#7a1010','hero_color_dark':'#300505'},
      ...
      'fungicide':{'template':'products/fungicides.html','page_title':'Fungicides','page_tag':'Disease Control',
       'page_desc':'Systemic and contact fungicides for prevention and control of fungal crop diseases.','hero_icon':'microscope','hero_color':'#2d1a6b','hero_color_dark':'#100a2a'},
...
def spec_sheet(request,product_id):
    ...
    LGRN=colors.HexColor('#e8f5e9'); LGRY=colors.HexColor('#f5f5f5'); WHT=colors.white; MUTED=colors.HexColor('#565656')
    CATC={'pesticide':colors.HexColor('#c43010'),'herbicide':MID,'fungicide':colors.HexColor('#5e35b1'),'other':colors.HexColor('#f57c00')}
